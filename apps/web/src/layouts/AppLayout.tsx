    ...
    >
      ...
      >
        ...
        >
          ...
          <span>CuerÃƒÆ’Ã‚Â¡maro Prime</span>
          <span style={{ opacity: 0.8, fontSize: 14 }}>PWA Ãƒâ€šÃ‚Â· v1.0</span>
        </div>
      ...
      >
        <nav
          aria-label="MenÃƒÆ’Ã‚Âº principal"
          style={{
            background: '#fff',
            borderRadius: 12,
            padding: 8,
      ...
      >
        Ãƒâ€šÃ‚Â© 2025 CuerÃƒÆ’Ã‚Â¡maro Prime
      </footer>
    </div>
  );
}
